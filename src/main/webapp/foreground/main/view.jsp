	...
	<div>
		...
		<div class="blog_keyword">
			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach items="${keyword}" var="keywordList">
                        &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/blog/q.html?q=${keyWord}" target="_blank">${keywordList}</a>&nbsp;&nbsp;
                    </c:forEach>
				</c:otherwise>
			</c:choose>
		</div>
...
<div class="data_list">
	<div class="data_list_title">
		<img src="/static/images/comment_icon.png" /> 评论信息
...
<div class="data_list" >
    ...
    <div class="publish_comment">
            ...
            <div class="verCode">
				...
				onkeydown="if(event.keyCode==13)form1.submit()" />&nbsp;<img onclick="javascript:loadimage();"  title="换一张试试" name="randImage" id="randImage" src="/image.jsp" width="60" height="20" border="1" align="absmiddle"> 
            </div>
