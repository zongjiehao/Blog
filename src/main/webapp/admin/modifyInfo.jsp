		...
		<table cellspacing="20px">
			<tr>
				...
				<td>
					...
					<input type="text" id="userName" name="userName" style="width: 200px" value="${blogger.userName }" readonly="readonly" />
				</td>
			</tr>
			<tr>
				<td>昵称：</td>
			...
			<tr>
				...
				<td>
					<script id="profile"  type="text/plain" style="width:876.67px;height:500px;"></script>
